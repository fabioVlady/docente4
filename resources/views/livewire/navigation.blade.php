      ...
      <div class="relative flex items-center justify-between h-16">
        ...
        <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
          ...
          <a href="/" class="flex-shrink-0 flex items-center">
            <img class="block lg:hidden h-8 w-auto" src="vendor/adminlte/dist/img/plantel2.png" alt="Workflow">
            <img class="hidden lg:block h-8 w-auto" src="vendor/adminlte/dist/img/plantel2.png" alt="Workflow">
            <strong style="color: white">&emsp;Personal Docente</strong>
          </a>
